...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        <a href="#" class="list-group-item active">查看景点</a>
        <a href="#" class="list-group-item">添加景点</a>
        <a href="#" class="list-group-item">修改景点</a>
        <a href="#" class="list-group-item">查询景点</a>
        <a href="#" class="list-group-item">删除景点</a>
    </ul>
</div>
<!--右侧主要内容-->
