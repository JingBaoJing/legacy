...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
            <ul class="list-group">
                <li><a href="/legacy1/Admin/Message/index" class="list-group-item active">查看留言</a></li>
                <li><a href="/legacy1/Admin/Message/reply" class="list-group-item">回复留言</a></li>
                                ...
                                <div class="tab-pane active" id="bulletin">
                                    <table class="table table-hover">
                                        ...
                                        <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="bg-danger">
                                            ...
                                            <td><a href="/legacy1/Admin/Message/delete/id/<?php echo ($v["id"]); ?>"> 删除</a></td>
