...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        <a href="/legacy1/Admin/Travel/index" class="list-group-item ">查看景点</a>
        <a href="/legacy1/Admin/Travel/add" class="list-group-item">添加景点</a>
        <a href="/legacy1/Admin/Travel/index" class="list-group-item">修改景点</a>
        <a href="/legacy1/Admin/Travel/search" class="list-group-item active">查询景点</a>
        <a href="/legacy1/Admin/Travel/index" class="list-group-item">删除景点</a>
    </ul>
</div>
<!--右侧主要内容-->
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="bg-success">
                        ...
                        <td>
                            <a type="button" class="btn btn-primary btn-sm" href="/legacy1/Admin/Travel/revise/id/<?php echo ($v["id"]); ?>">
                                <span class="glyphicon glyphicon-pencil"></span>编辑 </a>
                            <a type="button" class="btn btn-danger btn-sm" href="/legacy1/Admin/Travel/delete/id/<?php echo ($v["id"]); ?>">
