...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        ...
        <a href="/legacy1/Admin/Policy/index" class="list-group-item">修改政策</a>
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="bg-success">
                        ...
                        <td>
                            <a type="button" class="btn btn-primary btn-sm" href="/legacy1/Admin/Policy/revise/id/<?php echo ($v["id"]); ?>">
                                <span class="glyphicon glyphicon-pencil"></span>编辑 </a>
                            <a type="button" class="btn btn-danger btn-sm" href="/legacy1/Admin/Policy/delete/id/<?php echo ($v["id"]); ?>">
