...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        ...
        <a href="#" class="list-group-item  active">查询商品</a>
        <a href="#" class="list-group-item">删除商品</a>
    </ul>
</div>
<!--右侧主要内容-->
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="bg-success">
                        ...
                        <td>
                            <a type="button" class="btn btn-primary btn-sm" href="/legacy1/Admin/Goods/revise/goodname/<?php echo ($v["goodname"]); ?>">
