...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        <a href="/legacy1/Admin/Goods/index" class="list-group-item active">查看商品</a>
        <a href="/legacy1/Admin/Goods/add" class="list-group-item">添加商品</a>
        <a href="/legacy1/Admin/Goods/index" class="list-group-item">修改商品</a>
        <a href="/legacy1/Admin/Goods/search" class="list-group-item">查询商品</a>
        <a href="/legacy1/Admin/Goods/index" class="list-group-item">删除商品</a>
    </ul>
</div>
<!--右侧主要内容-->
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <?php if(is_array($res)): foreach($res as $key=>$v): ?><tr class="bg-success">
                        ...
                        <td>
                            <?php echo ($v["picname"]); ?>
                            <a href="/legacy1/Admin/Goods/goods/goodname/<?php echo ($v["rid"]); ?>" target="_blank"><?php if(empty($v["picname"])): ?><img src="/legacy1/Public/image/preview.jpg"><?php else: ?><img src="/legacy1/Public/uploads/thumb/<?php echo ($v["picname"]); ?>"><?php endif; ?></a>
                        </td>
                        <td>
                            <a type="button" class="btn btn-primary btn-sm" href="/legacy1/Admin/Goods/revise/id/<?php echo ($v["id"]); ?>">
                                <span class="glyphicon glyphicon-pencil"></span>编辑 </a>
                            <a type="button" class="btn btn-danger btn-sm" href="/legacy1/Admin/Goods/delete/id/<?php echo ($v["id"]); ?>">
