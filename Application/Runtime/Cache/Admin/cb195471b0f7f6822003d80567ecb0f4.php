...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        <a href="/legacy1/Admin/Goods/index" class="list-group-item">查看商品</a>
        <a href="/legacy1/Admin/Goods/add" class="list-group-item ">添加商品</a>
        <a href="/legacy1/Admin/Goods/index" class="list-group-item  active">修改商品</a>
            ...
            <div class="data-edit" align="center">
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                    <div class="container">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-5 col-md-6">
                                <input class="btn btn-info" type="submit" value="确定" />  <input type="button" class="btn btn-info" href="javascript:window.history.back();" value="返回">
                            </div>
                        </div>
                    </div>
                </form>
