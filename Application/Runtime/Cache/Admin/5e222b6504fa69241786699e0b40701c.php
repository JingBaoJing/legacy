...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        <a href="/legacy1/Admin/Inheritor/index" class="list-group-item ">查看传承人</a>
        <a href="/legacy1/Admin/Inheritor/add" class="list-group-item active">添加传承人</a>
                ...
                <form class="form-horizontal" method="post">
                    <div class="container">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-5 col-md-6">
                                <textarea class="form-control" rows="20" name="shiji"></textarea>
                            </div>
                        </div>
