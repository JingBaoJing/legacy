...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        <a href="index" class="list-group-item ">查看传承人</a>
        <a href="add" class="list-group-item">添加传承人</a>
        <a href="index" class="list-group-item active">修改传承人</a>
        <a href="search" class="list-group-item">查询传承人</a>
        <a href="index" class="list-group-item">删除传承人</a>
    </ul>
</div>
<!--右侧主要内容-->
