...
<head>
    ...
    <title>后台登录</title>
    <link href="/legacy1/Public/css/admin.css" rel="stylesheet" />
...
<div class="login_box">
    <form method="post">
        ...
        <table>
            ...
            <tr><td>&nbsp;</td><td><img src="/legacy1/Admin/Login/getVerify" onclick="this.src='/legacy1/Admin/Login/getVerify/'+Math.random()"/></td></tr>
